...
public class satellite_broadcast_source_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("reserved 26 uimsbf ");
        parseData("name_length 6 uimsbf ");
        // Use dynamic context length parse buffer
        parseBytes("char " + (contextGet("name_length")) * 8 + " uimsbf ");
        parseData("orbital_position 16 bslbf ");
        parseData("west_east_flag 1 bslbf ");
        parseData("reserved 7 bslbf ");
    }

    public String getName() {
        return "satellite_broadcast_source_descriptor";
    }
