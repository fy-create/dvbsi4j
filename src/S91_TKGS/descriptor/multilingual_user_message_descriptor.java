...
public class multilingual_user_message_descriptor extends CommonParser {
        ...
        parseData("descriptor_length 8 uimsbf ");
        {
            ...
            while (getToken() < _dynamic_12) // descriptor_length
            {
                pushElement();
                {
                    ...
                    parseData("message_length 8 uimsbf ");
                    // Use dynamic context length parse buffer
                    parseBytes("char " + (contextGet("message_length")) * 8 + " uimsbf ");
                }
                popElement();
            }
            popNode("languages");
    ...
    public String getName() {
        return "multilingual_user_message_descriptor";
    }
