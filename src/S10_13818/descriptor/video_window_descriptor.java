...
public class video_window_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("horizontal_offset 14 uimsbf ");
        parseData("vertical_offset 14 uimsbf ");
        parseData("window_priority 4 uimsbf ");
    }
