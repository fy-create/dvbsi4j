...
public class ibp_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("closed_gop_flag 1 uimsbf ");
        parseData("identical_gop_flag 1 uimsbf ");
        parseData("max_gop_length 14 uimsbf ");
    }
