...
public class multiplex_buffer_utilization_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("bound_valid_flag 1 bslbf ");
        parseData("LTW_offset_lower_bound 15 uimsbf ");
        parseData("reserved 1 bslbf ");
        parseData("LTW_offset_upper_bound 14 uimsbf ");
    }
