...
public class copyright_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("copyright_identifier 32 uimsbf ");
        // Use dynamic length parse buffer
        parseBytes("additional_copyright_info " + (getBufferLen() - getToken()) * 8 + " uimsbf ");
    }
