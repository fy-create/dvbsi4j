...
public class audio_stream_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("free_format_flag 1 bslbf ");
        parseData("ID 1 bslbf ");
        parseData("layer 2 bslbf ");
        parseData("variable_rate_audio_indicator 1 bslbf ");
