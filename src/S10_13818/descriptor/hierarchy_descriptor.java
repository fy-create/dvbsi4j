...
public class hierarchy_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("hierarchy_type 4 uimsbf ");
        parseData("reserved 2 bslbf ");
        parseData("hierarchy_layer_index 6 uimsbf ");
        parseData("reserved 2 bslbf ");
        parseData("hierarchy_embedded_layer_index 6 uimsbf ");
        parseData("reserved 2 bslbf ");
        parseData("hierarchy_channel 6 uimsbf ");
    }
