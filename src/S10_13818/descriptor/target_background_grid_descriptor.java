...
public class target_background_grid_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("horizontal_size 14 uimsbf ");
        parseData("vertical_size 14 uimsbf ");
        parseData("aspect_ratio_information 4 uimsbf ");
    }
