...
public class registration_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("format_identifier 32 uimsbf ");
        // Use dynamic length parse buffer
        parseBytes("additional_identification_info " + (getBufferLen() - getToken()) * 8 + " uimsbf ");
    }
