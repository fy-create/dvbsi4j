...
public class delegated_application_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseBytes("application_identifier " + (contextGet("descriptor_length")) * 8 + " uimsbf ");
    }

    public String getName() {
        return "delegated_application_descriptor";
    }
