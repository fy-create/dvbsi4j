...
public class dvb_html_application_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("appid_set_length 8 uimsbf ");
        // Use dynamic context length parse buffer
        parseBytes("application_id " + (contextGet("appid_set_length")) * 8 + " uimsbf ");
        // Use dynamic length parse buffer
        parseBytes("parameter_bytes " + (getBufferLen() - getToken()) * 8 + " uimsbf ");
    }

    public String getName() {
        return "dvb_html_application_descriptor";
    }
