...
public class transport_protocol_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("protocol_id 16 uimsbf ");
        parseData("transport_protocol_label 8 uimsbf ");
        // Use dynamic length parse buffer
        parseBytes("selector_byte " + (getBufferLen() - getToken()) * 8 + " uimsbf ");
    }
