...
public class application_icons_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("icon_locator_length 8 uimsbf ");
        // Use dynamic context length parse buffer
        parseBytes("icon_locator_byte " + (contextGet("icon_locator_length")) * 8 + " uimsbf ");
        parseData("icon_flags 16 bslbf ");
        // Use dynamic length parse buffer
        parseBytes("reserved_future_use " + (getBufferLen() - getToken()) * 8 + " uimsbf ");
    }

    public String getName() {
        return "application_icons_descriptor";
    }
