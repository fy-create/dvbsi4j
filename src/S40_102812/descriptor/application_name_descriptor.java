...
public class application_name_descriptor extends CommonParser {
        ...
        parseData("descriptor_length 8 uimsbf ");
        {
            ...
            while (getToken() < descriptor_length_bytes) // N
            {
                pushElement();
                {
                    ...
                    parseData("application_name_length 8 uimsbf ");
                    // Use dynamic context length parse buffer
                    parseBytes("application_name_char " + (contextGet("application_name_length")) * 8 + " uimsbf ");
                }
                popElement();
            }
            popNode("application_names");
        }
    }
