...
public class bouquet_association_section extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("bouquet_descriptors_length 12 uimsbf ");
        // Process DESCRIPTOR
        {
            int    bouquet_descriptors_length_bytes = contextGet("bouquet_descriptors_length");
            byte[] buffer                           = parseData(bouquet_descriptors_length_bytes * 8, false, false);
