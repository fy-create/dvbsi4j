...
public class running_status_section extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("section_length 12 uimsbf ");
        {
            ...
            int section_length_bytes = contextGet("section_length") + getToken();
            while (getToken() < section_length_bytes) // N
            {
                pushElement();
                {
