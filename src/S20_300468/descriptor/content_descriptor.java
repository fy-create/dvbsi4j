...
public class content_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("descriptor_length 8 uimsbf ");
        {
            ...
            while (getToken() < descriptor_length_bytes) // N
            {
                pushElement();
                {
                    parseData("content_nibble_level_1 4 uimsbf ");
                    parseData("content_nibble_level_2 4 uimsbf ");
                    parseData("user_byte 8 uimsbf ");
                }
                popElement();
            }
            popNode("contents");
