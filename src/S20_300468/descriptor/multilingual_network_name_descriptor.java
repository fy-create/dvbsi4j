...
public class multilingual_network_name_descriptor extends CommonParser {
        ...
        parseData("descriptor_length 8 uimsbf ");
        {
            ...
            while (getToken() < descriptor_length_bytes) // N
            {
                pushElement();
                {
                    ...
                    parseData("network_name_length 8 uimsbf ");
                    // Use dynamic context length parse buffer
                    parseBytes("char " + (contextGet("network_name_length")) * 8 + " uimsbf ");
                }
                popElement();
            }
            popNode("networks");
