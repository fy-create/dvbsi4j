...
public class multilingual_bouquet_name_descriptor extends CommonParser {
        ...
        parseData("descriptor_length 8 uimsbf ");
        {
            ...
            while (getToken() < descriptor_length_bytes) // N
            {
                pushElement();
                {
                    ...
                    parseData("bouquet_name_length 8 uimsbf ");
                    // Use dynamic context length parse buffer
                    parseBytes("char " + (contextGet("bouquet_name_length")) * 8 + " uimsbf ");
                }
                popElement();
            }
            popNode("bouquets");
