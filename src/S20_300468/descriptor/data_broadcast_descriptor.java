...
public class data_broadcast_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("data_broadcast_id 16 uimsbf ");
        parseData("component_tag 8 uimsbf ");
        parseData("selector_length 8 uimsbf ");
        // Use dynamic context length parse buffer
        parseBytes("selector_byte " + (contextGet("selector_length")) * 8 + " uimsbf ");
        parseData("ISO_639_language_code 24 bslbf ");
        parseData("text_length 8 uimsbf ");
        // Use dynamic context length parse buffer
        parseBytes("text " + (contextGet("text_length")) * 8 + " uimsbf ");
    }
