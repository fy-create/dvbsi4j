...
public class service_availbility_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("availability_flag 1 bslbf ");
        parseData("reserved 7 bslbf ");
        // Use dynamic length parse buffer
        parseBytes("cell_id " + (getBufferLen() - getToken()) * 8 + " uimsbf ");
    }

    public String getName() {
        return "service_availbility_descriptor";
    }
