...
public class VBI_teletext_descriptor extends CommonParser {
        ...
        parseData("descriptor_length 8 uimsbf ");
        {
            ...
            while (getToken() < descriptor_length_bytes) // N
            {
                pushElement();
                {
                    ...
                    parseData("teletext_type 5 uimsbf ");
                    parseData("teletext_magazine_number 3 uimsbf ");
                    parseData("teletext_page_number 8 uimsbf ");
                }
                popElement();
            }
            popNode("teletexts");
