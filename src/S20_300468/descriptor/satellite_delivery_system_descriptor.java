...
public class satellite_delivery_system_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        if (contextGet("modulation_system") == 1) {
            parseData("roll_off 2 bslbf ");
        } else {
            parseData("noused 2 bslbf ");
        }
        parseData("modulation_system 1 bslbf ");
        parseData("modulation_type 2 bslbf ");
