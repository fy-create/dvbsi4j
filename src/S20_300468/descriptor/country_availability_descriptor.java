...
public class country_availability_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("country_availability_flag 1 bslbf ");
        parseData("reserved_future_use 7 bslbf ");
        // Use dynamic length parse buffer
        parseBytes("country_code " + (getBufferLen() - getToken()) * 8 + " uimsbf ");
    }
