...
public class AAC_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("profile_and_level 8 uimsbf ");
        if (contextGet("descriptor_length") > 1) {
            parseData("AAC_type_flag 1 bslbf ");
            parseData("reserved 7 bslbf ");
            if (contextGet("AAC_type_flag") == 1) {
                parseData("AAC_type 8 uimsbf ");
            }
