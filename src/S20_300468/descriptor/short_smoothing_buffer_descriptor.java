...
public class short_smoothing_buffer_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("sb_size 2 uimsbf ");
        parseData("sb_leak_rate 6 uimsbf ");
        // Use dynamic length parse buffer
        parseBytes("DVB_reserved " + (getBufferLen() - getToken()) * 8 + " uimsbf ");
    }
