...
public class local_time_offset_descriptor extends CommonParser {
        ...
        parseData("descriptor_length 8 uimsbf ");
        {
            ...
            while (getToken() < descriptor_length_bytes) // N
            {
                pushElement();
                {
                    ...
                    parseData("country_region_id 6 bslbf ");
                    parseData("reserved 1 bslbf ");
                    parseData("local_time_offset_polarity 1 bslbf ");
                    parseData("local_time_offset 16 bslbf ");
                    parseData("time_of_change 40 bslbf ");
                    parseData("next_time_offset 16 bslbf ");
                }
                popElement();
            }
            popNode("time_offsets");
        }
    }
