...
public class service_relocated_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("old_original_network_id 16 uimsbf ");
        parseData("old_transport_stream_id 16 uimsbf ");
        parseData("old_service_id 16 uimsbf ");
    }
