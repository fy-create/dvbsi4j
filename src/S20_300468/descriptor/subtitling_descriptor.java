...
public class subtitling_descriptor extends CommonParser {
        ...
        parseData("descriptor_length 8 uimsbf ");
        {
            ...
            while (getToken() < descriptor_length_bytes) // N
            {
                pushElement();
                {
                    ...
                    parseData("subtitling_type 8 bslbf ");
                    parseData("composition_page_id 16 bslbf ");
                    parseData("ancillary_page_id 16 bslbf ");
                }
                popElement();
            }
            popNode("subtitles");
