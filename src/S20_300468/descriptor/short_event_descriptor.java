...
public class short_event_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("event_name_length 8 uimsbf ");
        // Use dynamic context length parse buffer
        parseBytes("event_name_char " + (contextGet("event_name_length")) * 8 + " uimsbf ");
