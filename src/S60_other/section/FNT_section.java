...
public class FNT_section extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseData("network_descriptors_loop_length 12 uimsbf ");
        // Process DESCRIPTOR
        {
            int    network_descriptors_loop_length_bytes = contextGet("network_descriptors_loop_length");
            byte[] buffer                                = parseData(network_descriptors_loop_length_bytes * 8, false, false);
