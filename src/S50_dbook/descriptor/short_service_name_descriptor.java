...
public class short_service_name_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseBytes("char " + (contextGet("descriptor_length")) * 8 + " uimsbf ");
    }

    public String getName() {
        return "short_service_name_descriptor";
    }
