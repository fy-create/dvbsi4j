 ...
 *******************************************************************************/
package S30_102809.descriptor;

import com.fyteck.dvbsi.CommonParser;

public class service_identifier_descriptor extends CommonParser {
    public void parse(byte[] descriptBuffer, int len) throws Exception {
        ...
        parseBytes("textual_service_identifier_bytes " + (contextGet("descriptor_length")) * 8 + " uimsbf ");
    }
